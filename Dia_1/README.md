...
Herramienta: Earth Engine Explorer
...
Guía de JavaScript en GEE
Objetos y Métodos de Earth Engine
Guía de Geometrías

Herramientas

Earth Engine Explorer ⭐ (empezamos aquí)
...
Crea variables con diferentes tipos de datos (números, strings, booleanos) y practica operadores
Crea un diccionario con información de tu ciudad (nombre, población, coordenadas)
Dibuja 3 puntos en el mapa y crea un buffer de 5km alrededor de cada uno

Nivel Intermedio

Crea una función que tome dos números y devuelva su suma (primero en JavaScript nativo, luego con objetos ee.Number)
Crea una colección de Features con 5 ciudades, incluyendo sus nombres y poblaciones como propiedades
Estiliza los puntos de las ciudades proporcionalmente a su población

Nivel Avanzado

Crea un polígono manualmente, divídelo en dos mitades usando operaciones geométricas
Experimenta con diferentes operaciones espaciales (intersection, union, difference) entre geometrías
Crea una función que genere buffers de tamaño variable según una propiedad numérica

🎓 Conceptos para Repasar en Casa

¿Cuál es la diferencia entre == y === en JavaScript?
¿Qué significa "client-side" vs "server-side" en Earth Engine?
¿Por qué no debemos usar loops for tradicionales con colecciones ee.*?
¿Cuál es la diferencia entre un objeto JavaScript {} y un ee.Dictionary?
¿Qué es un Feature y en qué se diferencia de una Geometry?

📚 Para Profundizar
Lecturas Recomendadas

Client vs Server: The Key Concept
Feature Collections

Videos Tutoriales

GEE Playlist oficial de Google

Comunidad

GEE Developers Forum
GEE en Stack Exchange
